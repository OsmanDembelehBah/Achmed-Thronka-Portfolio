...
const VideoGallery = () => {
  ...
  const videoData = {
    ...
    videoUrl: '/src/assets/videos/featured/Manager Interview.mp4',
    thumbnail: '/src/assets/images/gallery/leadership/Manager4.jpeg',
    duration: '15:30',
    date: '2024',
    category: 'Interview',
  };
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-600 dark:text-gray-300 mt-3">
            Watch Achmed Thronka's exclusive interview with SLBC
          </p>
        </motion.div>
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="bg-white dark:bg-navy/80 rounded-3xl overflow-hidden shadow-xl"
        >
          {/* Video Player */}
          <div className="relative bg-black aspect-video">
            ...
            <button
              onClick={togglePlay}
              className="absolute inset-0 flex items-center justify-center text-white/80 hover:text-white transition-colors duration-300 group"
            >
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-4">
              ...
              <div className="flex items-center justify-between text-white text-sm">
                <div className="flex items-center gap-4">
                  <button onClick={togglePlay} className="hover:text-gold transition">
                ...
                <button onClick={toggleFullscreen} className="hover:text-gold transition">
                  <Maximize size={18} />
                </button>
              </div>
            </div>
