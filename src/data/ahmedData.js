...
export const educationData = [
  {
    id: 1,
    institution: 'Services Senior Secondary School',
    location: 'Sierra Leone',
    period: 'Secondary Education',
    description: 'Developed a growing curiosity for leadership, business administration and the management of entertainment complexes.',
  },
  {
    id: 2,
    ...
    location: 'Sierra Leone',
    period: 'Secondary Education',
    description: 'Continued academic excellence and leadership development.',
  },
  {
    id: 3,
    institution: 'Milton Margai Technical University',
    location: 'Congo Cross, Freetown, Sierra Leone',
    period: 'Higher Education',
    description: 'Higher Diploma in Electrical and Electronics Engineering',
  },
  {
    id: 4,
    institution: 'Institute of Public Administration and Management (IPAM)',
    location: 'Sierra Leone',
    period: 'Higher Education',
...
export const careerData = [
  {
    id: 1,
    company: 'Antonio Casino (Bintumani Hotel)',
    position: 'Croupier / Dealer',
    period: 'Early Career',
    description: 'Started career in the hospitality and gaming industry, developing foundational skills in customer service and operations.',
  },
  {
    id: 2,
    company: 'Royal Casino',
    position: 'Cashier / Texas Manager',
    period: 'Career Growth',
    description: 'Progressed through multiple roles, gaining expertise in cash management, Texas poker operations, and team leadership.',
  },
  {
    id: 3,
    company: 'Kono Casino',
    ...
    period: '6 Months',
    description: 'Managed branch operations, overseeing staff, customer experience, and business performance.',
  },
  {
    id: 4,
    company: 'Grand Leone Group',
    position: 'General Manager',
    period: 'Current Position',
    description: 'Overseeing business operations, strategic planning, customer experience and organizational growth across the group.',
  },
  {
    id: 5,
    company: 'White Dove Electrical Engineering Company',
    position: 'Founder & CEO',
    period: 'Current Position',
    description: 'Leading the company in providing innovative electrical engineering solutions and supporting infrastructure development in Sierra Leone.',
  },
  {
    id: 6,
    company: 'Times Mansion',
    position: 'General Manager',
    period: 'Current Position',
    description: 'Leading a premier five-star hospitality establishment in Sierra Leone, delivering premium accommodation, exceptional customer service and luxury experiences.',
  },
];
